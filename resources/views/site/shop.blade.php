                    ...
                    <div class="shop__sidebar">
                        ...
                        <div class="sidebar__sizes">
                            ...
                            <div class="size__list">
                                ...
                                <label for="s">
                                    s
                                    <input type="checkbox" name="selectedSizes" value="S" id="s">
                                    <span class="checkmark"></span>
                                </label>
                                <label for="m">
                                    m
                                    <input type="checkbox" name="selectedSizes" value="M" id="m">
                                    <span class="checkmark"></span>
                                </label>
                                <label for="l">
                                    l
                                    <input type="checkbox" name="selectedSizes" value="L" id="l">
                                    <span class="checkmark"></span>
                                </label>
                                <label for="xl">
                                    xl
                                    <input type="checkbox" name="selectedSizes" value="XL" id="xl">
                                    <span class="checkmark"></span>
                                </label>
                                <button class="btn btn-outline-danger fw-bold">FILTER</button>
                            </div>
                        </div>
